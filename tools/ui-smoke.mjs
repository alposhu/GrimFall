...
check(filled.textContent.includes('Leon'), 'the save summary names the wrong hero');
filled?.click();
...
check(byId.continueSub.textContent.includes('Leon'), 'Continue does not describe the save');
saves.resetSaves();
ui.showTitle();
